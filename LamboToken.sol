...
contract LamboFarm is Context, IERC20, Ownable {
    ...
    string private _name = "LamboFarm";
    ...
    uint256 private _numTokensSellToAddToLiquidity = 1 * 10**4 * 10**9;
    ...
    constructor () public {
        ...
        IUniswapV2Router02 router = IUniswapV2Router02(0x213c25900f365F1BE338Df478CD82beF7Fd43F85 ); //v2 router
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount) private {
        if(_isExcludedFromFee[sender] || _isExcludedFromFee[recipient] || !_feeEnabled) {
            removeAllFee();
        }
        ...
        // send transfer to marketing wallet
    ...
    function setFeeEnabled() external onlyOwner() {
        _feeEnabled = true;
    }
}
